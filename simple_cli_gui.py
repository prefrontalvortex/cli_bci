...
def main():
    ...
    for i in range(N):
        ...
        # infeed = sys.stdin.read()
        # screen.addstr(8, 2, infeed)
...
def resize_terminal(rows=23, cols=79):
    ...
    sys.stdout.flush()
    time.sleep(0.1) # delay keeps curses from breaking on wrong terminal window size. Why? idk.



# -----------------------------------------------------------------------------
if __name__ == '__main__':
    eegHandler = simple_osc.EEGHandler()

    simple_osc.main(eegHandler)
